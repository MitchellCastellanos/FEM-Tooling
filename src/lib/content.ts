...
// Aviso de privacidad tal cual lo entregó Mitchell (9 sept. 2026). Se publica
// verbatim — no se reescribe texto legal sin autorización. OJO: contiene dos
// inconsistencias frente al resto del sitio que hay que confirmar con el
// cliente antes de lanzar (ver CHECKLIST.md):
//   1) El correo de contacto ARCO es "contacto@cncmaquinados.com" — un dominio
//      distinto a femtooling.com. Parece un aviso reutilizado de otra empresa
//      (CNC Maquinados) sin actualizar. Alguien que ejerza sus derechos ARCO
//      escribiendo ahí no llegaría a FEM TOOLING.
//   2) El teléfono aquí es +52 442 779 6991 y el horario 8am-5pm, distintos al
//      +52 442 261 5052 / 8am-4pm que se usa en Contacto y en el footer.
